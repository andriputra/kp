			...
			<div class="card-container">
				<div class="card">
					...
					<div class="card-content">
						<h3>News #1</h3>
						<p class="paraf">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
							tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
							quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
						consequat.</p>
						<p class="date">20 sep 2023, 08:00</p>
						<p class="penulis">By Admin</p>
						<a href="berita-detail.php" class="btn">Read More</a>
					</div>
				</div>
				<div class="card">
					<img src="assets/img/img 1.jpg">
